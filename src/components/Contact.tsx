          ...
          {contacts.map((c) => {
            ...
            return (
              <a
                ...
                aria-label={c.label}
                className="group flex items-center gap-3 rounded-2xl border border-white/10 bg-ink-900 px-5 py-4 text-left transition-all duration-300 ease-out hover:-translate-y-[3px] hover:border-white/20 hover:shadow-lg hover:shadow-black/40"
              >
