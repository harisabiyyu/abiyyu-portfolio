...
const areas = [
  ...
  },
  {
    num: '03',
    title: 'Exploring',
    body: 'UI/UX design, Git, GitHub, deployment, and game development.',
    icon: Compass,
  },
];
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {areas.map((a) => {
            ...
            return (
              <div
                key={a.num}
                className="reveal group relative overflow-hidden rounded-2xl border border-white/10 bg-ink-900 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-white/20"
              >
                <div
                  aria-hidden
